...
![Ảnh minh họa](../_images/TOSS.DM.AIRPORT_UPDATE.img01.png)

```mermaid
flowchart TD
    subgraph SG1["User"]
        S0(("●"))
        A1["1. Người dùng truy cập ODP, mở đến danh mục =&gt; Sân bay"]
        A2["2. Chọn chức năng &quot;Sửa sân bay&quot; trên một bản ghi"]
        A4["4. Nhập dữ liệu và nhấn &quot;Lưu lại&quot;"]
    end
    subgraph SG2["Hệ thống"]
        A3["3. Hiển thị màn hình &quot;Sửa sân bay&quot;"]
...
![Ảnh minh họa](../_images/TOSS.DM.AIRPORT_UPDATE.img02.png)
...
| --- | --- | --- | --- | --- |
|  | Edit airport | Title |  | * Fix cứng text “Edit airport” * ![Ảnh minh họa](../_images/TOSS.DM.AIRPORT_UPDATE.img03.png) => click > thực hiện đóng popup và không cần xử lý gì |
