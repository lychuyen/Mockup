...
![Ảnh minh họa](../_images/TOSS.DM.COUNTRY_DELETE.img01.png)
...
flowchart TD
    ...
    subgraph LANE_SYS["Hệ thống"]
        S3["3. Hiển thị màn hình xác nhận Xóa quốc gia"]
