...
feature_name: "[Tìm kiếm chuyến bay](../TOSS.FLC.DOCUMENT/TOSS.FLC.FLIGHT_SEARCH.FD.v0.1.md) và thông tin fuel order"
group: "Fuel order"
---

> **Phạm vi file:** Feature F09 (nhóm Fuel order) — trích trung thực 100% từ nguồn SRS Flight Load Control do người soạn (CLAUDE.md §0), không suy diễn, không bổ sung. Cờ điểm cần xác nhận: xem CATALOG.md dòng #9 (thứ tự cột lọc khác F04 — DEP trước ETD; ETD không có STT; tham chiếu "kịch bản chức năng ẩn hiện filter" trỏ Google Docs ngoài).

## **[Tìm kiếm chuyến bay](../TOSS.FLC.DOCUMENT/TOSS.FLC.FLIGHT_SEARCH.FD.v0.1.md) và thông tin fuel order**

| **Tên chức năng: [Tìm kiếm chuyến bay](../TOSS.FLC.DOCUMENT/TOSS.FLC.FLIGHT_SEARCH.FD.v0.1.md) và thông tin fuel order** | |
| --- | --- |
| **Mục đích** | Cho phép user xem [tìm kiếm chuyến bay](../TOSS.FLC.DOCUMENT/TOSS.FLC.FLIGHT_SEARCH.FD.v0.1.md) và thông tin fuel order |
...
> Chuyển từ ảnh sơ đồ luồng gốc (UML Activity, 2 làn User/TOSS) trong Google Doc nguồn — ảnh gốc lưu tại [`_images/TOSS.FLC.FUEL_ORDER_SEARCH.sodo-luong.png`](../_images/TOSS.FLC.FUEL_ORDER_SEARCH.sodo-luong.png).
...
flowchart TD
    ...
    subgraph SG2["TOSS"]
        ...
        B6["(6) Hiển thị danh sách chuyến bay và thông tin Fuel Order thỏa mãn điều kiện lọc"]
...
**Nguồn trích:** `sec-12-tim-kiem-chuyen-bay-va-thong-tin-fuel-or.md` (mảnh phân rã h2 từ `VNA.TOSS_SRS_Flight Load Control_v0.1.md`, đã xóa sau khi tách theo Feature — git giữ lịch sử) · CATALOG.md dòng #9. **Đồng bộ lại 2026-07-10 theo Google Doc version 2192** (sửa 2026-07-10T10:57:39Z bởi chuyenly2003; bản phân rã trước theo version 2074) — nội dung không đổi; lưu ý nguồn KHÔNG gạch bỏ "Set current page=1"/"chân trang =" như bên tab Document.
