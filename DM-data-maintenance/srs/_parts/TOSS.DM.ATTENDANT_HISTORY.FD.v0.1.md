...
|  | System | Textview | system\_name/systemName | * Hiển thị [systemNam] theo dữ liệu API trả về * Trường hợp API trả về rỗng/lỗi: để trống trường |
