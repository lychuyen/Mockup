...
| 8 | Bước 8 | Đóng popup. Hiển thị toast message thành công [TB019](https://docs.google.com/document/d/1L5y0t4FCWe_vnNI65xNMRC-LM3lvLwYsQRAm_Nokv9A/edit?tab=t.0#bookmark=kix.spmzvpry3i7f). Reload danh sách: ![Ảnh minh họa](../_images/TOSS.DM.AC_SUBTYPE_ADD_EDIT.img02.png)  ![Ảnh minh họa](../_images/TOSS.DM.AC_SUBTYPE_ADD_EDIT.img03.png) |

#### Màn hình chức năng

![Ảnh minh họa](../_images/TOSS.DM.AC_SUBTYPE_ADD_EDIT.img04.png)

![Ảnh minh họa](../_images/TOSS.DM.AC_SUBTYPE_ADD_EDIT.img05.png)
...
|  | **![Ảnh minh họa](../_images/TOSS.DM.AC_SUBTYPE_ADD_EDIT.img06.png)** | Icon |  | * Click Icon => Đóng màn hình thêm mới/ sửa => Điều hướng về màn trước đó * Dữ liệu thay đổi không được lưu vào DB |
|  | **![Ảnh minh họa](../_images/TOSS.DM.AC_SUBTYPE_ADD_EDIT.img07.png)** | Button |  | * Click button Hủy bỏ => Đóng màn hình thêm mới/ sửa => Điều hướng về màn trước đó * Dữ liệu thay đổi không được lưu vào DB |
