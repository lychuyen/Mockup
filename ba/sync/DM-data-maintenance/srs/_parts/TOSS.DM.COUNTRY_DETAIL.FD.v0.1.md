...
|  | ![](data:image/png;base64...) | Button | btn\_edit | * Click button=> Hiển thị popup [Sửa quốc gia](TOSS.DM.COUNTRY_EDIT.FD.v0.1.md) |
|  | ![](data:image/png;base64...) | Button | btn\_delete | * Click button=> Hiển thị popup [Xóa quốc gia](TOSS.DM.COUNTRY_DELETE.FD.v0.1.md) |
| Thông tin chi tiết | | | | |
|  | Country code | Textview | country\_code/countryCode | Hiển thị [countryCode] theo dữ liệu API trả về  Trường hợp API trả về rỗng/lỗi: để trống trường |
|  | Country name | Textview | country\_name/countryName | Hiển thị [countryName] theo dữ liệu API trả về  Trường hợp API trả về rỗng/lỗi: để trống trường |
|  | Abbreviation | Textview | abbreviation\_name/abbreviationName | Hiển thị [abbreviationName] theo dữ liệu API trả về  Trường hợp API trả về rỗng/lỗi: để trống trường |
