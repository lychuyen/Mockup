...
> **Nguồn gốc (truy vết):** Tách trung thực từ `sec-04-danh-sach-flight-plan.md` — mảnh phân rã `TOSS.FD.ALL.FD.v0.1.md` (SRS Flight Dispatch v0.1, người soạn VNA/VTIT, nguồn Google Drive live pull 2026-07-10) — ứng với dòng **#1** bảng §1 trong [CATALOG.md](CATALOG.md). Không sửa nội dung nguồn (CLAUDE.md §0).
