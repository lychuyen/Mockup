...
| Danh sách sân bay  ![](data:image/png;base64...)  FE call API lấy lại DS sân bay mới nhất hiện tại để hiển thị trên giao diện người dùng  Các dữ liệu sân bay được đồng bộ từ hệ thống FIMS, bao gồm các thông tin sau:   * IATA/ICAO * Name * Region * Country * Fleets | | | | |
|  | List of airports | Title |  | * Fix cứng text “List of airports” |
|  | ![](data:image/png;base64...) | Button |  | * Click vào => hệ thống thực hiện tạo file .xlsx để tải danh sách Airport về máy * Tên file tải về: FIMS\_sân bay\_ddmmyyhhmm * File: [FIMS\_PILOT\_090226\_0854.xlsx](https://docs.google.com/spreadsheets/d/1jvVJpj-4XHxs-WZjo5hkfi-CmYEZQGMVce8_6Uf2yNc/edit?usp=sharing) * Nội dung file tải về: tải theo cột dữ liệu view từ bảng Airport |
|  | ![](data:image/png;base64...) | Button |  | * Click button → Mở popup “Create new” |
