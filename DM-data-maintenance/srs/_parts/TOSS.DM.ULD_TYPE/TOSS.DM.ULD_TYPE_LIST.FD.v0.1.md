...
![Ảnh minh họa](../_images/TOSS.DM.ULD_TYPE_LIST.img01.png)
...
flowchart TD
    ...
    subgraph SG2["Hệ thống"]
        A2["2. Gọi API để lấy dữ liệu danh mục loại ULD."]
        A3["3. Hiển thị màn hình danh sách loại ULD."]
        E0((("●")))
    end
    S0 --> A1
    A1 --> A2
...
![Ảnh minh họa](../_images/TOSS.DM.ULD_TYPE_LIST.img02.png)
...
| Danh sách ULD Type  *(hình ảnh minh họa — xem file gốc/Google Doc)*  FE call API lấy lại DS ULD Type mới nhất hiện tại để hiển thị trên giao diện người dùng | | | | |
| **2** | ULD Type Master List | Title |  | * Fix cứng text “ULD Type Master List” |
| **3** | ![Ảnh minh họa](../_images/TOSS.DM.ULD_TYPE_LIST.img03.png) | Button | btn_export | * Click vào => hệ thống thực hiện tạo file .xlsx để tải danh sách ULD Type về máy * Tên file tải về: Fims_ULD_Type_ddmmyy_hhmm * File tham khảo: [Fims_ULD_Type__ddmmyy_hhmm](https://docs.google.com/spreadsheets/d/1tSBAI99-KdfE8dJAOaljwinDFyud7Ey9Mr1pDREbviM/edit?usp=drive_link) * Nội dung file tải về: tải theo cột dữ liệu view từ bảng ULD Type |
| **4** | ![Ảnh minh họa](../_images/TOSS.DM.ULD_TYPE_LIST.img04.png) | Button | btn_create | * Click button → Mở popup “Thêm mới” |
