...
| 9 | ·ICAO | Textbox | icao\_code | * Hiển thị [icao\_code] theo dữ liệu API trả về * Trường hợp API trả về rỗng/lỗi: hiện placeholder “Select ICAO” * Không bắt buộc nhập * Các giá trị regionTypeId API trả về * **Action**: Nhấn Enter/out focus/click button **Save**, hệ thống lưu thông tin ghi chú. Không có thông tin, lưu trống |
