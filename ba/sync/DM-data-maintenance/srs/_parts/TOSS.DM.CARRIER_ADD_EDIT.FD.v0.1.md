...
| 6 | Save | Button |  | Luôn Enable, nếu nhập thông tin thêm mới/ sửa đủ và đúng định dạng, hệ thống thực hiện   * Lưu thông tin thêm mới, cập nhật * Hiển thị màn hình thông báo kết quả nếu: * Response API trả về status 200: hiển thị toast message thành công:   ![](data:image/png;base64...)  ![](data:image/png;base64...)  => Đóng popup thêm mới/ sửa và trở về màn hình Danh mục Carrier   * Ngược lại: hiển thị toast message lỗi tương ứng với API trả về:   ![](data:image/png;base64...)![](data:image/png;base64...)   * Sau 3s hoặc người dùng click “x” đóng toast |
