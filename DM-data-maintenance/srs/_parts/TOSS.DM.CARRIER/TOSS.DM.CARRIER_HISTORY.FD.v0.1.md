...
![Ảnh minh họa](../_images/TOSS.DM.CARRIER_HISTORY.img01.png)
...
flowchart TD
    subgraph LANE_USER["User"]
        ...
        U2["(2) Click icon xem lịch sử tại danh sách hoặc button xem lịch sử tại màn xem chi tiết/sửa"]
    end
...
![Ảnh minh họa](../_images/TOSS.DM.CARRIER_HISTORY.img02.png)
