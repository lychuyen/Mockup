...
feature_id: "TOSS.FLC.THONG_TIN_CHUNG"
...
> Pull 2026-07-10 (version 2074, sửa 2026-07-10T03:03:55.729Z bởi lyphat676). **Đồng bộ lại 2026-07-10 theo Google Doc version 2192** (sửa 2026-07-10T10:57:39Z bởi chuyenly2003) — phần Thông tin chung (trang bìa, Mục đích, Phạm vi tài liệu, Khái niệm/thuật ngữ) KHÔNG thay đổi giữa 2 phiên bản.
...
Mã hiệu tài liệu: **VNA.FIMS_SRS_Flight_Load_Control_v1.0**
...
> **Nguồn gốc (truy vết):** Gộp trung thực từ `sec-00-front-matter.md` + `sec-01-muc-dich.md` + `sec-02-pham-vi-tai-lieu.md` + `sec-03-khai-niem-thuat-ngu.md` (bản trích SRS Flight Load Control v0.1, người soạn VNA/VTIT) thành 1 file theo quy ước đặt tên `TOSS.<PhanHe>.<TenChucNang>.FD.v<x>.md` — xem §0 [CATALOG.md](CATALOG.md). Không sửa nội dung nguồn (CLAUDE.md §0).
>
> **Ghi chú ranh giới:** 4 dòng tiêu đề cuối `sec-03` gốc (B - THIẾT KẾ CHI TIẾT → Document) là tiêu đề nhóm mở đầu phần "Thiết kế chi tiết" tiếp theo (không có nội dung riêng) — đã có ở dạng nhóm chức năng trong bảng §1 CATALOG.md, không lặp lại ở đây để tránh trùng.
