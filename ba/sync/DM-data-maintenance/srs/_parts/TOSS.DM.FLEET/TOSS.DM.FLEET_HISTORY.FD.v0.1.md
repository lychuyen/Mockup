...
![Ảnh minh họa](../_images/TOSS.DM.FLEET_HISTORY.img02.png)
...
| --- | --- | --- | --- | --- |
| **Thông tin chung** | | | | |
| **1** | Download file | Button |  | * Click vào => hệ thống thực hiện tạo file .xlsx để tải lịch sử Đội bay * Tên file tải về: Fims_Lich su_Doibay_ddmmyyhhmm * Nội dung file tải về: tải theo cột dữ liệu view từ bảng Đội bay |
| **Lịch sử đội bay** | | | | |
