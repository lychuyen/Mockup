...
|  | cancel / Đóng | Button |  | * Đóng với màn hình Sửa * Hủy bỏ với màn hình Thêm mới * Lươn enable, click button đóng giao diện Thêm mới/ Sửa, hệ thống không xử lý gì thêm, trở ra màn hình [danh sách Tàu bay](TOSS.DM.AIRCRAFT_LIST.FD.v0.1.md) |
