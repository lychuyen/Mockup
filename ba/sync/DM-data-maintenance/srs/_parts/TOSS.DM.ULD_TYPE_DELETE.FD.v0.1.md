...
feature_name: "[Xóa ULD](TOSS.DM.ULD_DELETE.FD.v0.1.md) Type"
---

> **Ngữ cảnh chương (giữ nguyên từ nguồn):** mục `Data Maintenance (Danh mục dùng chung)`.

### [Xóa ULD](TOSS.DM.ULD_DELETE.FD.v0.1.md) Type

| **Tên chức năng: Xoá ULD Type** | |
| --- | --- |
| **Mục đích** | Cho phép user [xóa ULD](TOSS.DM.ULD_DELETE.FD.v0.1.md) Type |
| **Trigger** | Người dùng truy cập vào web FIMS => nhấn phân hệ Danh mục => Nhấn chọn ULD Type => Xem chi tiết => Chọn icon Xóa |
| **Tiền điều kiện** | Người dùng đăng nhập thành công và được phân quyền [xóa ULD](TOSS.DM.ULD_DELETE.FD.v0.1.md) Type |
...
1. Sơ đồ luồng [xóa ULD](TOSS.DM.ULD_DELETE.FD.v0.1.md) Type
...
| **3** | Bước 3 | Mở màn hình xác nhận **[Xóa ULD](TOSS.DM.ULD_DELETE.FD.v0.1.md) Type** |
...
| **7** | Bước 7,8 | Trường hợp thành công: BE Lưu và cập nhật danh sách ULD Type , trường **is\_delete=true**  Trả API thành công cho FE  FE Hiển thị toast thành công cho người dùng [TB019](https://docs.google.com/document/d/1L5y0t4FCWe_vnNI65xNMRC-LM3lvLwYsQRAm_Nokv9A/edit?tab=t.0#bookmark=kix.spmzvpry3i7f)  ![](data:image/png;base64...)  Đóng popup xác nhận [Xóa ULD](TOSS.DM.ULD_DELETE.FD.v0.1.md) Type , tự động refresh màn danh sách và hiển thị Danh sách ULD Type mới nhất |

#### Màn hình chức năng

![](data:image/png;base64...)

1. Giao diện [xóa ULD](TOSS.DM.ULD_DELETE.FD.v0.1.md) Type
...
*Nguồn: tách trung thực từ `sec-28-quan-ly-danh-muc-loai-uld.md`, mục "[Xóa ULD](TOSS.DM.ULD_DELETE.FD.v0.1.md) Type" (bản trích text của `VNA.TOSS_SRS_Data Maintenance_v0.1.docx`, chương Data Maintenance (Danh mục dùng chung)) — tương ứng dòng **#39** bảng §1 của [CATALOG.md](CATALOG.md). Không chỉnh sửa nội dung nguồn (CLAUDE.md §0). 🖼 Hình ảnh màn hình: xem file `VNA.TOSS_SRS_Data Maintenance_v0.1.docx` gốc.*
