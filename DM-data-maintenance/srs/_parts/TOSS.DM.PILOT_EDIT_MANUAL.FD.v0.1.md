...
| --- | --- | --- | --- | --- |
|  | Edit pilot information | Title |  | * Fix cứng text “Edit pilot information” * ![](data:image/png;base64...) => click > thực hiện đóng popup và không cần xử lý gì |
