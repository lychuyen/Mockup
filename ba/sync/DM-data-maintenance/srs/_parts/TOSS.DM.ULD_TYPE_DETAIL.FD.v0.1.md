...
feature_name: "[Xem chi tiết ULD](TOSS.DM.ULD_DETAIL.FD.v0.1.md) Type"
---

> **Ngữ cảnh chương (giữ nguyên từ nguồn):** mục `Data Maintenance (Danh mục dùng chung)`.

### [Xem chi tiết ULD](TOSS.DM.ULD_DETAIL.FD.v0.1.md) Type

| **Tên chức năng: [Xem chi tiết ULD](TOSS.DM.ULD_DETAIL.FD.v0.1.md) Type** | |
| --- | --- |
| **Mục đích** | Cho phép user [Xem chi tiết ULD](TOSS.DM.ULD_DETAIL.FD.v0.1.md) Type |
...
| **Hậu điều kiện** | Mở màn hình [Xem chi tiết ULD](TOSS.DM.ULD_DETAIL.FD.v0.1.md) Type -Thông tin ULD Type trên giao diện người dùng |

#### Sơ đồ luồng hệ thống

![](data:image/png;base64...)

1. Sơ đồ luồng [xem chi tiết ULD](TOSS.DM.ULD_DETAIL.FD.v0.1.md) Type
...
| **5** | Bước 5 | Hiển thị màn hình [Xem chi tiết ULD](TOSS.DM.ULD_DETAIL.FD.v0.1.md) Type |

#### Màn hình chức năng

![](data:image/png;base64...)

1. Giao diện [xem chi tiết ULD](TOSS.DM.ULD_DETAIL.FD.v0.1.md) Type
...
*Nguồn: tách trung thực từ `sec-28-quan-ly-danh-muc-loai-uld.md`, mục "[Xem chi tiết ULD](TOSS.DM.ULD_DETAIL.FD.v0.1.md) Type" (bản trích text của `VNA.TOSS_SRS_Data Maintenance_v0.1.docx`, chương Data Maintenance (Danh mục dùng chung)) — tương ứng dòng **#40** bảng §1 của [CATALOG.md](CATALOG.md). Không chỉnh sửa nội dung nguồn (CLAUDE.md §0). 🖼 Hình ảnh màn hình: xem file `VNA.TOSS_SRS_Data Maintenance_v0.1.docx` gốc.*
