...
![Ảnh minh họa](../_images/TOSS.DM.EMAIL_DETAIL.img02.png)
...
|  | x | Button | btn_close | Click button=> Đóng popup, trở về giao diện trước đó, không cần xử lý gì |
|  | Edit | Button | btn_edit | Click button=> Mở popup Edit Email |
|  | History | Button | btn_history | Click button=> Mở popup History of Email |
