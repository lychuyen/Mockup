...
|  | User click button chức năng Sửa ![](data:image/png;base64...) |
...
| --- | --- | --- | --- | --- |
|  | Edit flight attendant information | Title |  | * Fix cứng text Edit flight attendant information” * ![](data:image/png;base64...) => click > thực hiện đóng popup và không cần xử lý gì |
