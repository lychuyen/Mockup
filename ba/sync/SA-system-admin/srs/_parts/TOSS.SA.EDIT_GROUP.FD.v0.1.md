...
|  | Bước 5 | Hệ thống kiểm tra dữ liệu, nếu:   * Trường hợp thiếu dữ liệu bắt buộc/Sai định dạng valid/Call API tạo mới người dùng cho FIMS có lỗi => Báo lỗi theo bước 6 * Ngược lại: [Sửa Người dùng](TOSS.SA.EDIT_USER.FD.v0.1.md) thành công => Thực hiện tiếp bước 7 & 8 |
...
|  | Bước 7 | Trường hợp [sửa người dùng](TOSS.SA.EDIT_USER.FD.v0.1.md) thành công: BE Lưu và cập nhật danh sách nhóm Users  Trả API thành công cho FE |
|  | Bước 8 | FE Hiển thị toast thành công cho người dùng [TB019](https://docs.google.com/document/d/1L5y0t4FCWe_vnNI65xNMRC-LM3lvLwYsQRAm_Nokv9A/edit?tab=t.0#bookmark=kix.spmzvpry3i7f)  ![](data:image/png;base64...)  Đóng popup Sửa, tự động refresh màn danh sách và hiển thị [Danh sách Nhóm Người dùng](TOSS.SA.GROUP_LIST.FD.v0.1.md) mới nhất |
