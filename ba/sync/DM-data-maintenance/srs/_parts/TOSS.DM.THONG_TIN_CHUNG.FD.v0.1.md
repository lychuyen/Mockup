...
feature_id: "TOSS.DM.THONG_TIN_CHUNG"
...
Mã hiệu tài liệu: **VNA.FIMS_SRS_Data Maintenance_v1.0**
...
[**I - PHÂN HỆ QUẢN LÝ ĐIỀU HÀNH BAY_FIMS 1**](#_heading=h.9lbkjwqojjnv)
...
[5.1.2. Xem chi tiết Phi công_Thông tin Phi công 1](#_heading=h.x0r6jxnisxbn)

[5.1.3. Xem chi tiết Phi công_Lịch sử 1](#_heading=h.8ezlv2s0vrbj)
...
[5.2.2. Xem chi tiết Tiếp viên_Thông tin Tiếp viên 1](#_heading=h.wog7ccz2ydjv)

[5.2.3. Xem chi tiết Tiếp viên_Lịch sử 1](#_heading=h.r7enfjoet7id)
...
> **Nguồn gốc (truy vết):** Gộp trung thực từ `sec-00-front-matter.md` + `sec-01-muc-dich.md` + `sec-02-pham-vi-tai-lieu.md` + `sec-03-khai-niem-thuat-ngu.md` (bản trích SRS Data Maintenance v0.1, người soạn VNA/VTIT) thành 1 file theo quy ước đặt tên `TOSS.<PhanHe>.<TenChucNang>.FD.v<x>.md` — xem §0 [CATALOG.md](CATALOG.md). Không sửa nội dung nguồn (CLAUDE.md §0).
>
