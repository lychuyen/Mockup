...
feature_name: "[Tìm kiếm chuyến bay](TOSS.FLC.FLIGHT_SEARCH.FD.v0.1.md) và thông tin fuel order"
group: "Fuel order"
---
...
## **[Tìm kiếm chuyến bay](TOSS.FLC.FLIGHT_SEARCH.FD.v0.1.md) và thông tin fuel order**

| **Tên chức năng: [Tìm kiếm chuyến bay](TOSS.FLC.FLIGHT_SEARCH.FD.v0.1.md) và thông tin fuel order** | |
| --- | --- |
| **Mục đích** | Cho phép user xem [tìm kiếm chuyến bay](TOSS.FLC.FLIGHT_SEARCH.FD.v0.1.md) và thông tin fuel order |
...
**Nguồn trích:** `sec-12-tim-kiem-chuyen-bay-va-thong-tin-fuel-or.md` (mảnh phân rã h2 từ `TOSS.FLC.ALL.FD.v0.1.md`, đã xóa sau khi tách theo Feature — git giữ lịch sử) · CATALOG.md dòng #9.
