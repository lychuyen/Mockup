...
parent: "BRD-TOSS-001-khung-v0.12.md"
---

# Yêu cầu Nghiệp vụ — Phân hệ 5: Quản trị hệ thống (IAM/RBAC, Tích hợp, Hạ tầng, Chuẩn UI)

> **Tài liệu con của [BRD-TOSS-001-khung-v0.12.md](../../BRD-TOSS-001-khung-v0.12.md).** Phân rã chi tiết §7.5 — Phân hệ 5.
>
> **Phạm vi:** PH5 là phân hệ owner của IAM/RBAC (các phân hệ 1–4 áp dụng từ đây), chuẩn UI toàn hệ thống, cây menu, tích hợp các hệ thống ngoài qua API Gateway, hạ tầng Cloud + định cỡ, audit log, session, notification (TOSS.DM.EMAIL/ACARS push), import/export & migrate dữ liệu.
>
