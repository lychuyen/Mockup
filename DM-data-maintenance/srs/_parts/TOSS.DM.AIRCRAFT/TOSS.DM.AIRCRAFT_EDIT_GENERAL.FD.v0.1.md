...
![Ảnh minh họa](../_images/TOSS.DM.AIRCRAFT_EDIT_GENERAL.img01.png)
...
flowchart TD
    ...
    subgraph SGS["Hệ thống"]
        ...
        A4["(4) Hiển thị General Information"]
        A6["(6) Mở màn hình Edit General Information"]
...
![Ảnh minh họa](../_images/TOSS.DM.AIRCRAFT_EDIT_GENERAL.img02.png)
