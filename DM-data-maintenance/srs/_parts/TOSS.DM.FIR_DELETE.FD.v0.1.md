...
|  | Save | Button | btn\_delete | Click:   * Đóng popup xác nhận * FE call API update FIR thành **Đã xóa** * Xử lý Response API trả về, nếu:   **Status = 200**:   * + Hiển thị toast message thành công   ![](data:image/png;base64...)   * + Sau 3s hoặc người dùng bấm X: đóng toast   + Update trạng thái của fir trên danh sách thành **Đã xóa,** không còn hiệu lực sử dụng.   **Status ≠ 200**:   * + Hiển thị toast message lỗi   ![](data:image/png;base64...)   * + Sau 3s hoặc người dùng bấm X: đóng toast   + Hệ thống không cần xử lý gì |
