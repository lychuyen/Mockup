...
![Ảnh minh họa](../_images/TOSS.DM.COUNTRY_EDIT.img01.png)

```mermaid
flowchart TD
    subgraph LANE_USER["User"]
        START(("●"))
        U1["1. Người dùng truy cập ODP, mở đến danh mục =&gt; quốc gia"]
        U2["2. Chọn chức năng &quot;Sửa quốc gia&quot; trên một bản ghi"]
        U4["4. Nhập dữ liệu và nhấn &quot;Lưu lại&quot;"]
    end
    subgraph LANE_SYS["Hệ thống"]
        S3["3. Hiển thị màn hình &quot;Sửa quốc gia&quot;"]
...
![Ảnh minh họa](../_images/TOSS.DM.COUNTRY_EDIT.img02.png)
