...
![Ảnh minh họa](../_images/TOSS.DM.EMAIL_LIST.img02.png)
...
|  | Add new | Button | btn_add_new | * Luôn Enble * Click button, gọi chức năng Create Email |
|  | ![Ảnh minh họa](../_images/TOSS.DM.EMAIL_LIST.img03.png) | Button | btn_export_excel_email | * Click vào => hệ thống thực hiện tạo file .xlsx để tải danh sách Email về máy * Tên file tải về: FIMS_Email_ddmmyyhhmm * File: * Nội dung file tải về: tải theo cột dữ liệu view từ bảng Email |
