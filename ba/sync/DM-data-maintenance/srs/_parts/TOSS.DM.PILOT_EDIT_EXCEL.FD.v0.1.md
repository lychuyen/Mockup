...
| --- | --- | --- | --- | --- |
|  | [Sửa thông tin Phi công](TOSS.DM.PILOT_EDIT_MANUAL.FD.v0.1.md) bằng excel | Title |  | * Fix cứng text “[Sửa thông tin Phi công](TOSS.DM.PILOT_EDIT_MANUAL.FD.v0.1.md) bằng excel” * ![](data:image/png;base64...) => click > thực hiện đóng popup và không cần xử lý gì |
|  | Content 1 | Textview |  | * Fix cứng text:   “Kéo thả tệp vào đây  hoặc  [Button]  Các định dạng được chấp nhận là .xlsx (tối đa 5MB)” |
|  | ![](data:image/png;base64...) | Button | btn\_import\_choose\_file | * Theo kịch bản [Choose file](https://docs.google.com/document/d/1L5y0t4FCWe_vnNI65xNMRC-LM3lvLwYsQRAm_Nokv9A/edit?tab=t.0#heading=h.7420ow4jct8r) |
...
|  | Link temp mẫu ![](data:image/png;base64...) | Button link | btn\_import\_download\_template | Theo kịch bản [download template file](#bookmark=id.j4tc7tclmlst) |
|  | Action theo kịch bản [Action](#bookmark=id.vtjdsoy6718c). [Template Import Phi\_cong\_v0.2.xlsx](https://docs.google.com/spreadsheets/d/1b58zlNf_qAkiHcLdSjJ3yBq6RayxXPvl/edit?usp=sharing&ouid=100481381661925960730&rtpof=true&sd=true) | | | |
